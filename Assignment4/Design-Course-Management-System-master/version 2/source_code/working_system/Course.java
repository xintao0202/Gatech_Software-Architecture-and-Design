...
public class Course {
	...
	public void showCourseInfo(){
		try{/*
			...
			*/
			System.out.println(this.courseId + ", "+ this.courseTitle + ", " + this.courseSeats);
		} catch (Exception e){
	...
	/**
	 * @method to get the total available seats for the course
	 * @param assignments
	 */
	public void getTotalSeats(List<Assignment> assignments) {
		// TODO Auto-generated method stub
		for (Assignment assignment:assignments){
			if (assignment.courseId == this.courseId){
				this.courseSeats += assignment.capacity;
			}
